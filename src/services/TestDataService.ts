...
import { getLanguageData, getPromotionWithDiscount, getSnippetSetId, updateAdminUser } from './HeyFrameDataHelpers';
...
export class TestDataService {
     ...
     *
     * @param roundingDecimals - Decimals of the rounding shown in Frontend, default value 2
     ...
     * @param roundingDecimals - The roundings of item and total values in frontend, default 2 decimals
     */
