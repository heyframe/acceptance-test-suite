...
import type { Flow, FlowTemplate, Promotion } from '../types/HeyFrameTypes';
...
export const getPaymentMethodId = async (adminApiContext: AdminApiContext, handlerId?: string): Promise<string> => {
    const handler = handlerId || 'HeyFrame\\Core\\Checkout\\Payment\\Cart\\PaymentHandler\\InvoicePayment';
