...
export class AdminApiContext {
    ...
    private static readonly defaultOptions: AdminApiContextOptions = {
        ...
        client_id: process.env['HEYFRAME_ACCESS_KEY_ID'],
        client_secret: process.env['HEYFRAME_SECRET_ACCESS_KEY'],
        admin_username: process.env['HEYFRAME_ADMIN_USERNAME'] || 'admin',
        admin_password: process.env['HEYFRAME_ADMIN_PASSWORD'] || 'heyframe',
