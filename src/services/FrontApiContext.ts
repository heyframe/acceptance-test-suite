...
export class FrontApiContext {
    ...
    public static async create(options?: StoreApiContextOptions) {
        ...
        return new FrontApiContext(await this.createContext(contextOptions), contextOptions);
    }
    ...
    private static async createContext(options: StoreApiContextOptions) {
        ...
        return await request.newContext({
            baseURL: `${options['app_url']}front-api/`,
    ...
    async login(user: StoreUser) {
        ...
        this.context = await FrontApiContext.createContext(this.options);
