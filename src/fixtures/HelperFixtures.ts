...
import { getCurrency, getLanguageData } from '../services/HeyFrameDataHelpers';
...
export const test = base.extend<NonNullable<unknown>, FixtureTypes>({
    IdProvider: [
        ...
        async ({}, use, workerInfo) => {
            const seed = process.env.HEYFRAME_ACCESS_KEY_ID || process.env.HEYFRAME_ADMIN_PASSWORD || 'test-suite';
