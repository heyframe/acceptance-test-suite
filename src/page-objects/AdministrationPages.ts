...
import { HeyFrameServices } from './administration/HeyFrameServices';
...
export interface AdministrationPageTypes {
    ...
    AdminHeyFrameServices: HeyFrameServices;
    AdminMedia: Media;
...
export const test = base.extend<FixtureTypes>({
    ...
    AdminHeyFrameServices: async ({ AdminPage }, use) => {
        await use(new HeyFrameServices(AdminPage));
    },
