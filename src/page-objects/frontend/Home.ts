...
export class Home implements PageObject {
    ...
    constructor(page: Page) {
        ...
        this.accountMenuButton = page.getByLabel(translate('frontend:home:account.yourAccount'));
        ...
        this.consentOnlyTechnicallyRequiredButton = page.getByRole('button', { name: translate('frontend:home:consent.onlyTechnicallyRequired'), exact: true });
        this.consentConfigureButton = page.getByRole('button', { name: translate('frontend:home:consent.configure'), exact: true });
        this.consentAcceptAllCookiesButton = page.getByRole('button', { name: translate('frontend:home:consent.acceptAllCookies'), exact: true });
        this.consentCookiePreferences = page.getByLabel(translate('frontend:home:consent.cookiePreferences'));
        this.consentCookiePermissionContent = page.locator('.cookie-permission-content');
        this.consentDialog = page.getByRole('dialog').filter({ hasText: translate('frontend:home:consent.cookiePreferences') });
        ...
        this.consentDialogMarketingdCheckbox = this.consentDialog.getByRole('checkbox', { name: translate('frontend:home:consent.marketing'), exact: true });
        this.consentDialogMarketingCheckbox = this.consentDialog.getByRole('checkbox', { name: translate('frontend:home:consent.marketing'), exact: true });
        ...
        this.manufacturerFilter = this.filterMultiSelect.getByRole('button', { name: translate('frontend:home:filters.manufacturer') });
        this.propertyFilters = page.locator('.filter-multi-select-properties');
        this.priceFilterButton = page.getByRole('button', { name: translate('frontend:home:filters.price') }).first();
        this.resetAllButton = page.getByRole('button', { name: translate('frontend:home:filters.resetAll') });
        this.freeShippingFilter = page.getByRole('checkbox', { name: translate('frontend:home:filters.freeShipping') });
