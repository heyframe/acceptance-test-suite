...
export class AccountAddressCreate implements PageObject {
    ...
    constructor(page: Page) {
        this.page = page;
        this.salutationDropdown = page.getByRole('combobox', { name: translate('frontend:address:common.salutation') });
        this.firstNameInput = page.getByRole('textbox', { name: translate('frontend:address:common.firstName') });
        this.lastNameInput = page.getByRole('textbox', { name: translate('frontend:address:common.lastName') });
        this.companyInput = page.getByRole('textbox', { name: translate('frontend:address:common.company') });
        this.departmentInput = page.getByRole('textbox', { name: translate('frontend:address:common.department') });
        this.streetInput = page.getByRole('textbox', { name: translate('frontend:address:common.street') });
        this.zipcodeInput = page.getByRole('textbox', { name: translate('frontend:address:common.postalCode') });
