...
export class OffCanvasCart implements PageObject {
    ...
    constructor(page: Page) {
        this.page = page;
        this.headline = page.getByRole('heading', { name: translate('frontend:checkout:cart.shoppingCart') });
        this.itemCount = page.locator('.offcanvas-cart-header-count');
        this.goToCheckoutButton = page.getByRole('link', { name: translate('frontend:checkout:cart.goToCheckout') });
        this.goToCartButton = page.getByRole('link', { name: translate('frontend:checkout:cart.displayShoppingCart') });
        this.continueShoppingButton = page.getByRole('button', { name: translate('frontend:checkout:cart.continueShopping') });
        ...
        this.cartQuantityNumber = page.getByLabel(translate('frontend:product:quantity'), { exact: true });
    }
