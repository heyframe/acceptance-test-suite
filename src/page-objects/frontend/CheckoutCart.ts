...
export class CheckoutCart implements PageObject {
    ...
    constructor(page: Page) {
        ...
        this.enterPromoInput = page.getByLabel(translate('frontend:checkout:cart.promoCode'));
        this.grandTotalPrice = page.locator('dt:has-text("Grand total") + dd:visible');
        this.emptyCartAlert = page.getByText(translate('frontend:checkout:cart.emptyCart'));
        this.stockReachedAlert = page.getByText(translate('frontend:checkout:cart.stockReached'));
