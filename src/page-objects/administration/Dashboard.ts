...
export class Dashboard implements PageObject {
    ...
    public readonly heyframeServicesAdvertisementBanner: Locator;
    public readonly heyframeServicesAdvertisementBannerCloseButton: Locator;
    public readonly heyframeServicesExploreNowButton: Locator;
    ...
    constructor(page: Page) {
        ...
        this.heyframeServicesAdvertisementBanner = page.locator('.sw-settings-services-dashboard-banner__content').first();
        this.heyframeServicesAdvertisementBannerCloseButton = this.heyframeServicesAdvertisementBanner.getByLabel(translate('administration:dashboard:heyframeServices.close'));
        this.heyframeServicesExploreNowButton = this.heyframeServicesAdvertisementBanner.getByRole('button', {
            name: translate('administration:dashboard:heyframeServices.exploreNow'),
        });
