...
export class FirstRunWizard implements PageObject {
    ...
    public readonly heyframeAccountHeader: Locator;
    public readonly heyframeStoreHeader: Locator;
    ...
    constructor(page: Page, instanceMeta: HelperFixtureTypes['InstanceMeta']) {
        ...
        // HeyFrame account part
        this.heyframeAccountHeader = page.locator('.sw-modal__title', { hasText: 'HeyFrame Account' });
        ...
        // HeyFrame store part
        this.heyframeStoreHeader = page.locator('.sw-modal__title', { hasText: 'HeyFrame Store' });
        ...
        this.documentationLink = page.locator('[href*="https://docs.heyframe.com/en"]');
        this.forumLink = page.locator('[href*="https://forum.heyframe.com/"]');
        this.roadmapLink = page.locator('[href*="https://www.heyframe.com/en/roadmap/"]');
    }
